...
void def_new_min(std::map<std::string, float>& most_frequent_ngrams,
	std::string& key_min, float& freq_min);

void compare_freq(std::map<std::string, float>& most_frequent_ngrams, std::string new_key, 
	float freq, unsigned nb_sentences, std::string& key_min, float& freq_min);
...
void update_most_frequent_ngrams_safe(std::mutex& map_mutex, 
	std::map<std::string, float>& most_frequent_ngrams, 
	std::map<std::string, float>& most_frequent_ngrams_tmp, 
	unsigned nb_sentences, std::string& key_min, float& freq_min);
