...
void collect_filenames(std::vector<std::string>& filenames, const char* path_to_files, std::string suffix);
...
FILE* get_file(int thread_id, std::string filename, 
	const char* path_directory, std::string filename_end, std::string new_filename_end);
